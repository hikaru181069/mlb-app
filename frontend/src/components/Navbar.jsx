    ...
    <div className="flex h-full flex-col px-3 py-6">
      ...
      <div className="mt-auto flex flex-col gap-1 border-t border-ctp-surface1/50 pt-5">
        {token ? (
          ...
          <>
            <NavLink to="/login" onClick={close} className={sidebarLinkClass}>
              Login
            </NavLink>
            <NavLink
              to="/register"
              onClick={close}
              className="flex items-center justify-center rounded-lg bg-ctp-blue px-3 py-2 text-sm font-semibold text-ctp-base transition-colors duration-150 hover:bg-ctp-sapphire"
            >
              Register
            </NavLink>
          </>
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 top-0 z-50 flex h-14 items-center gap-3 border-b border-ctp-surface1/50 bg-ctp-mantle/85 px-4 backdrop-blur-lg md:hidden">
        ...
        >
          <img src="https://www.mlbstatic.com/team-logos/league-on-dark/1.svg" alt="MLB" className="h-6 w-6" />
          <span className="text-base font-black tracking-tight">MLB App</span>
        </NavLink>
      </div>
